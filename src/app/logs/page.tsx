...
export default function LogsPage(){
  ...
  <div className="grid grid-cols-1 xs:grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4">
    ...
    <div className="relative col-span-1 sm:col-span-2 lg:col-span-2">
      ...
      <input
        ...
        className="w-full pl-10 pr-4 py-2 bg-slate-800/50 border border-slate-700/50 rounded-md text-white placeholder-slate-400 focus:outline-none focus:border-violet-500/50 text-sm"
      />
    </div>
    ...
    <div>
      <select
        ...
        className="w-full px-3 py-2 bg-slate-800/50 border border-slate-700/50 rounded-md text-white focus:outline-none focus:border-violet-500/50 text-sm"
      >
    ...
    {/* Results Count */}
    <div className="flex items-center justify-center gap-2 text-slate-400 text-xs sm:text-sm col-span-1">
          ...
          {(activeTab === 'system' ? filteredLogs : aiLogs).length === 0 ? (
            ...
            <div className="divide-y divide-slate-800/50">
              {(activeTab === 'system'
                ...
                <div
                  key={index}
                  className={`p-4 border-l-4 ${getLogColor(
    ...
    {/* Pagination footer */}
    <div className="mt-3 text-sm text-slate-400 flex flex-col sm:flex-row items-center justify-between gap-3">
      <div>Page {page}</div>
